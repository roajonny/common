...
tb.write ("    integer int_TST_INDEX;\n")
...
tb.write ("    // Stimulus generator + response analyzer\n")
tb.write ("    initial begin\n\n")
tb.write ("        // Initialization sequence\n")
tb.write ("        init();\n")
tb.write ("        strobe_rst_n(); int_TST_INDEX++;\n\n")
tb.write ("        // Perform your testbench operations\n")
tb.write ("        // DUT_INPUT_PORT <= l_tb_stim[0]; (pseudo)\n\n")
tb.write ("        // -----------------\n")
tb.write ("        // TEST CASE #1\n")
tb.write ("        // -----------------\n\n")
tb.write ("        $display(\"[T=%0t] TEST CASE #%0d START\", $time, int_TST_INDEX);\n\n")
tb.write ("        // $assert()\n")
tb.write ("        //    $display(\"\");\n")
tb.write ("        // else begin\n")
tb.write ("        //    $error(\"\");\n")
tb.write ("        //    int_ERR_COUNT++;\n")
tb.write ("        // end\n\n")
tb.write ("        $display(\"[T=%0t] SIMULATION COMPLETE | # ERRORS: %0d\", $time, int_ERR_COUNT);\n")
tb.write ("    end\n\n")
...
tb.write ("    // --  (D) HELPER TASKS   --\n")
tb.write ("    // =========================\n\n")
tb.write ("    // Sets up default simulation values \n")
...
tb.write ("        // Makes all event timestamps printed to terminal readable \n")
tb.write ("        $timeformat(-9, 2, \" ns\");\n\n")
tb.write ("        int_TST_INDEX        <= 0;\n")
...
tb.write ("    task wait_50ns(); begin\n")
tb.write ("        #(p_CLK_PERIOD*50);\n")
tb.write ("    end\n")
tb.write ("    endtask\n\n")
