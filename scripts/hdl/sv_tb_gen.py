...
f = open ("sv_tb_template.sv", "w")

# Generate the header
f.write ("`timescale 1ns / 1ps\n\n")
f.write ("// File :            FILE_NAME_tb.sv\n")
...
f.write ("//                   \"tb_stim.txt\" which is read into memory \"l_tb_stim\"\n")
...
f.write ("//\n")
f.write ("//                   ---   -------------------------\n")
f.write ("//                    |    | B3  | B2  | B1  | B0  | (l_tb_stim[0])\n")
f.write ("//                    |    -------------------------\n")
f.write ("//                    |    | B7  | B6  | B5  | B4  | (l_tb_stim[1])\n")
f.write ("//                    4    -------------------------\n")
f.write ("//                    |    | ..  | ..  | ..  | ..  | (l_tb_stim[2])\n")
f.write ("//                    |    -------------------------\n")
f.write ("//                    |    | B15 | ..  | ..  | ..  | (l_tb_stim[3])\n")
f.write ("//                   ---   -------------------------\n")
f.write ("//\n")
...
f.write ("        #(p_CLK_PERIOD/2); l_clk <= ~l_clk;\n")
f.write ("    end\n\n")
...
f.write ("        // DUT_INPUT_PORT <= l_tb_stim[0]; (pseudo)\n")
f.write ("    end\n\n")
...
f.write ("        $readmemh(\"tb_stim.txt\", l_tb_stim, 0, p_STIM_CNT-1);\n\n")
f.write ("        int_ERR_COUNT        <= 0;\n")
f.write ("        l_clk                <= 1'b1;\n")
f.write ("        l_rst_n              <= 1'b1;\n\n")
