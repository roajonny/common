...
f.write ("    (\n")
f.write ("        parameter p_PARAMETER_0 = 32,\n")
f.write ("        parameter p_PARAMETER_1 = 32\n")
f.write ("    )\n")
f.write ("    (\n")
f.write ("        input  wire i_clk,\n")
f.write ("        input  wire i_rst_n,\n\n")
f.write ("        input  wire [p_PARAMETER_0-1:0] i_sig1,\n")
f.write ("        output wire [p_PARAMETER_1-1:0] o_sig2\n")
f.write ("    );\n\n")
